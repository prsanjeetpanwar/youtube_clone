...
import {
  ...
  return (
    <div className='w-2/12 bg-[#212121] pr-5 overflow-y-auto pb-8 sidebar'>
      ...
      <ul className='flex flex-col border-b-2 border-gray-700'>
        {secondaryLinks.map(({icon,name})=>{
            return (
                <li key={name} className={`pl-6 py-3 hover:bg-zinc-900`}>
  <a href="#" className='flex items-center gap-5'>
    {icon}
    <span className='text-sm tracking-wider '>{name}</span>
  </a>
      ...
      <ul className='flex gap-2 flex-wrap text-sm py-4 text-zinc-400'>
